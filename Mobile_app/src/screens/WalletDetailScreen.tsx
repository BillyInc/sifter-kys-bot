...
const WalletDetailScreen: React.FC<WalletDetailScreenProps> = ({ route }) => {
    ...
    <ScrollView style={styles.container}>
      ...
      {inList && (
        <View style={styles.card}>
          ...
          {(() => {
            const w = watchlist.find((x: any) => x.wallet_address === wallet.wallet_address);
            ...
            return (
              <>
                ...
                {w?.degradation_alerts && JSON.parse(w.degradation_alerts).map((a: any, i: number) => (
